...
if(isset($_POST['cadastrar']) && $_POST['cadastrar'] == 'Cadastrar') {
	...
	if(!empty($_POST['nome']) && !empty($_POST['cidade']) && !empty($_POST['estado']) && !empty($_POST['crea']) && !empty($_POST['funcao']) && !empty($_POST['curriculum'])) {
		...
		$pessoasVO->setCrea(urlencode($_POST['crea']));
...
$all = $pessoasBO->buscaPessoas($pessoasVO, $inicio, $TAMANHO_PAGINA,$palavra);
//print_r($all);
$areaAdmin = 'pessoas';
?>
	...
	<div id="wrapper">    	
        ...
        <div id="containerHolder">
			<div id="container">            	
                ...
                <div id="conteudo">
                	<h2><a href="principal.php">Dashboard</a> &raquo; <a href="#" class="active">Pessoas</a></h2>
                    <div id="main">
                    	<?php if($msg != "") { ?><div class="errMsg"><?=$msg?></div><?php } ?>
                    	<h3>Pessoas cadastradas</h3>
                    	<h5>BUSCA POR NOMES</h5>
						<?php include('busca_pessoas.php'); ?>
                    	<?php if(count($all) > 0) { ?>
                    ...
                    <div class="paginacao">
                    	...
                    	<?php if($pagina < $total_paginas) { ?><span class="next"><a href="pessoas.php?page=<?=$pagina+1?>">Pr&oacute;xima &raquo;</a></span><?php } ?>
                    </div>
                    <?php } ?>
                </div>
                <div class="clear"></div>
