            ...
            <div class="col-md-12">
                <div class="block">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Demonstra√ß√µes</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <!-- NESSE PEDA«O DE C”DIGO, COLOQUEI A MESMA ESTRUTURA QUE USO NO admin/visualizar-demo.php
                ...
                ao invÈs de v·rias fancyboxes que abrem e d„o play no video. … mais trabalhoso de fazer.
                Essa classe embed-container precisa ser arrumada (height est· zuado e eu nao sei como arrumar)
                ou atÈ mesmo trocada de nome, com o nome que vc achar melhor,
                pra poder ter uma listagem bonitinha;
                AtÈ deixei as outras divs ali embaixo, caso vc ainda precise usar.
             -->
